...
{
    public class NewtonSolverOptsGH : GH_Component
    {
        int reportType;
        ...
        /// </summary>
        public NewtonSolverOptsGH()
          : base("SolverOptions", "SolverOptions",
                "Basic solver options for inflatable sheets and periodic units.",
                "iSheet", "Model")
        {
        }
        ...
        {
            get { return new Guid("0c9d3a53-3ec9-49ec-ac6e-2a9c3ec4ef2c"); }
        }
    }
}
