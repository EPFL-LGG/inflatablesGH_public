...
{
    public class MultipleSheetsSolverGH : GH_Component
    {
        private bool run;
        private MultipleSheets copy;
        ...
        /// </summary>
        public MultipleSheetsSolverGH()
          : base("MultipleSheetsSolver", "MultipleSheetsSolver",
                "Newton solver for multiple inflatable sheets.",
                "Isheet", "Model")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            else
            {
                ...
                {
                    this.Message = "Reset";
                    copy = (MultipleSheets)model.Clone();
                ...
                if (run)
                {
                    ...
                    bool equilibrium = NewtonSolver.MultipleSheetOptimizeMultipleSteps(copy, opts1, out report, true, false);
                    ...
                    if (opts.NumIterationsWithoutTempSupports > 0)
                    {
                        ...
                        equilibrium = NewtonSolver.MultipleSheetOptimizeMultipleSteps(copy, opts2, out report, true, false, false);
                    }
        ...
        {
            get { return new Guid("8319a0a9-1b27-4b0d-a952-036223c3f6a9"); }
        }
    }
}
