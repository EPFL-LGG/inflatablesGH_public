import os
import sys; sys.path.append(os.path.join(os.path.dirname(__file__), '..')); sys.path.append(os.path.join(os.path.dirname(__file__),'../..'))
...
def helper_run_equilibrium(ipu, allow_bending,  stiffness_pressure, disableFusedRegionTFT = False, useTFT = True):
