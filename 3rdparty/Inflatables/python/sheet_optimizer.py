...
class PySheetOptimizer():
    def __init__(self, targetAttractedSheet, fixedVars = [], cb = None, hessianShift = 0.0, renderMode = RenderMode.PYTHREEJS,
        ...
        self.rso = inflation.ReducedSheetOptimizer(targetAttractedSheet, fixedVars, opts, cb, hessianShift, detActivationThreshold, initialVars, originalDesignMesh=originalDesignMesh)
    ...
    def screenshotPath(self, path):
        ...
        if (path[-4:] == '.mp4'):
            ...
            if self.flat_viewer is not None:
    ...
    def recordingVideo(self):
        ...
        if self.flat_viewer is None: return drec
    ...
    def viewer(self):
        ...
        if self.flat_viewer is not None:
            ...
            return self.deploy_viewer.show()
