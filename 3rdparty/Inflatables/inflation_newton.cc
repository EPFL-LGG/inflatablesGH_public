...
template ConvergenceReport inflation_newton<InflatablePeriodicUnit  >(InflatablePeriodicUnit &,   const std::vector<size_t> &, const NewtonOptimizerOptions &, CallbackFunction, Real, Real, Real);
template ConvergenceReport inflation_newton<InflatableMidSurfacePeriodicUnit  >(InflatableMidSurfacePeriodicUnit &,   const std::vector<size_t> &, const NewtonOptimizerOptions &, CallbackFunction, Real, Real, Real);
...
template std::unique_ptr<NewtonOptimizer> get_inflation_optimizer<InflatablePeriodicUnit  >(InflatablePeriodicUnit   &, const std::vector<size_t> &, const NewtonOptimizerOptions &, CallbackFunction, Real, Real, Real);
template std::unique_ptr<NewtonOptimizer> get_inflation_optimizer<InflatableMidSurfacePeriodicUnit  >(InflatableMidSurfacePeriodicUnit   &, const std::vector<size_t> &, const NewtonOptimizerOptions &, CallbackFunction, Real, Real, Real);


#include "MultilayerInflatable.hh"
template ConvergenceReport inflation_newton<MultilayerInflatable>(MultilayerInflatable &, const std::vector<size_t> &, const NewtonOptimizerOptions &, CallbackFunction, Real, Real, Real);
template std::unique_ptr<NewtonOptimizer> get_inflation_optimizer<MultilayerInflatable>(MultilayerInflatable &, const std::vector<size_t> &, const NewtonOptimizerOptions &, CallbackFunction, Real, Real, Real);