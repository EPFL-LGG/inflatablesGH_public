...
#ifndef MY_CGAL_STREAM_LINES_2_H_ 
#define MY_CGAL_STREAM_LINES_2_H_
...
template <class VectorField_2, class Integrator_2>
    class Custom_Stream_lines_2
    {
        ...
        protected:
            ...
            void make_iterator();
        public:
            Custom_Stream_lines_2(const Vector_field_2 & m_vector_field_2, const Integrator_2 & m_integrator, const FT
...
template <class VectorField_2, class Integrator_2>
    Custom_Stream_lines_2<VectorField_2, Integrator_2>::Custom_Stream_lines_2(const Vector_field_2 & vector_field_2, const Integrator_2 & m_integrator, const FT & m_separating_distance, const FT & m_saturation_ratio, const int & sampling_step, const bool & step_by_step)
    {
        ...
        pPoint = Point_2(max_x+separating_distance,max_y+separating_distance);
        m_DT.insert(pPoint);
        std::cout << "Inserting points into Delaunay triangulation" << std::endl;
        for (FT i=(min_x-separating_distance);i<max_x+separating_distance;i+=fSepStl_seed)
        {
            pPoint = Point_2((FT)i,(FT)max_y+separating_distance);
            m_DT.insert(pPoint);
            pPoint = Point_2((FT)max_x+separating_distance,(FT)i);
...
template <class VectorField_2, class Integrator_2>
    void Custom_Stream_lines_2<VectorField_2, Integrator_2>::place_stream_lines(const Vector_field_2 & vector_field_2, const Integrator_2 & integrator, const int & sampling_step, const bool & step_by_step)
    {
        std::cout << "place_stream_lines" << std::endl;
        ...
        else
        {
            Point_container_2 stl;
            Vertex_container_2 stl_vertices;
            std::cout << "integrating streamline " << stl_container.size() << std::endl;
            integrate_streamline(vector_field_2, integrator, stl, seed_point, stl_vertices, sampling_step);
            std::cout << "\tinserting streamline" << std::endl;
            insert_streamline(vector_field_2, stl, stl_vertices);
...
template <class VectorField_2, class Integrator_2>
    bool Custom_Stream_lines_2<VectorField_2, Integrator_2>::continue_next(const Vector_field_2 & vector_field_2, const Integrator_2 & integrator, const int & sampling_step)
    {
        FT distance;
        Point_container_2 stl;
        Vertex_container_2 stl_vertices;
...
template <class VectorField_2, class Integrator_2>
    void 
    Custom_Stream_lines_2<VectorField_2,Integrator_2>::integrate_streamline(const Vector_field_2 & vector_field_2, const Integrator_2 & integrator, Point_container_2& stl, Point_2&
...
template <class VectorField_2, class Integrator_2>
    inline
    typename Custom_Stream_lines_2<VectorField_2, Integrator_2>::FT 
    Custom_Stream_lines_2<VectorField_2, Integrator_2>::find_smallest_circle(const Vertex_handle & pVertex_handle)
    {
...
template <class VectorField_2, class Integrator_2>
    inline 
    typename Custom_Stream_lines_2<VectorField_2, Integrator_2>::Vertex_handle 
    Custom_Stream_lines_2<VectorField_2, Integrator_2>::insert_point(const Point_2 & pPoint, FT& fDist,bool bDistanceCalculation)
    {
...
template <class VectorField_2, class Integrator_2>
    inline
    typename Custom_Stream_lines_2<VectorField_2, Integrator_2>::Vertex_handle
    Custom_Stream_lines_2<VectorField_2,Integrator_2>::insert_point(const Point_2 & pPoint, const Face_handle & m_Face_handle, FT& fDist,bool bDistanceCalculation)
    {
...
template <class VectorField_2, class Integrator_2>
    void
    Custom_Stream_lines_2<VectorField_2, Integrator_2>::integrate_forward(const Vector_field_2 & vector_field_2, const Integrator_2 & integrator, Point_container_2& stl, Point_2& seed_point_, Vertex_container_2& stl_vertices, const int & sampling_step)
    {
...
template <class VectorField_2, class Integrator_2>
    void Custom_Stream_lines_2<VectorField_2, Integrator_2>::integrate_backward(const Vector_field_2 & vector_field_2, const Integrator_2 & integrator, Point_container_2& stl, Vertex_container_2& stl_vertices, const int & sampling_step)
    {
        int sampling = 0; // sampling step;
        int insertion = 0; // insertion order;
        int insertion_step = 0;
...
template <class VectorField_2, class Integrator_2>
    inline void
    Custom_Stream_lines_2<VectorField_2, Integrator_2>::
...
template <class VectorField_2, class Integrator_2>
    void Custom_Stream_lines_2<VectorField_2, Integrator_2>::
            ...
            const Vertex_handle & m_Vertex_handle, int size_)
    {
        ...
        template <class VectorField_2, class Integrator_2>
            inline 
            bool
            Custom_Stream_lines_2<VectorField_2, Integrator_2>::get_next_seed_point(FT &
        ...
        template <class VectorField_2, class Integrator_2>
            typename Custom_Stream_lines_2<VectorField_2, Integrator_2>::Stream_line_iterator_2
            Custom_Stream_lines_2<VectorField_2, Integrator_2>::begin()
            {
        ...
        template <class VectorField_2, class Integrator_2>
            typename Custom_Stream_lines_2<VectorField_2, Integrator_2>::Stream_line_iterator_2
            Custom_Stream_lines_2<VectorField_2, Integrator_2>::end()
            {
                return end_iterator;
            }
        ...
        template <class VectorField_2, class Integrator_2>
            inline
            void Custom_Stream_lines_2<VectorField_2, Integrator_2>::make_iterator()
            {
        ...
        template <class VectorField_2, class Integrator_2>
            void
            Custom_Stream_lines_2<VectorField_2, Integrator_2>::print_stream_lines_eps(std::ofstream & fw)
            {
        ...
        template <class VectorField_2, class Integrator_2>
            void 
            Custom_Stream_lines_2<VectorField_2, Integrator_2>::print_stream_lines(std::ofstream & fw)
            {
                typename Stream_line_container_2::iterator it;
                Stream_line_container_2 stl_container_temp = stl_container;
        ...
        template <class VectorField_2, class Integrator_2>
            std::list<typename Custom_Stream_lines_2<VectorField_2, Integrator_2>::Point_2> 
            Custom_Stream_lines_2<VectorField_2, Integrator_2>::get_pq()
            {
